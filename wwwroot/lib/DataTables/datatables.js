 ...
 *   https://datatables.net/download/#dt/dt-1.13.8/sc-2.3.0/sb-1.6.0/sp-2.2.0
 *
 * Included libraries:
 *   DataTables 1.13.8, Scroller 2.3.0, SearchBuilder 1.6.0, SearchPanes 2.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.8/sc-2.3.0/sb-1.6.0/sp-2.2.0",
